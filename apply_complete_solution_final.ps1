# Script para aplicar la solución completa, incluyendo la actualización de las Edge Functions y la verificación del webhook de IA
# Este script ejecuta todos los scripts PowerShell para solucionar el problema del webhook de IA

# Mostrar información
Write-Host "Aplicando la solución completa al problema del webhook de IA, incluyendo la actualización de las Edge Functions y la verificación del webhook de IA..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Todas las soluciones han sido aplicadas correctamente, incluyendo la actualización de las Edge Functions y la verificación del webhook de IA." -ForegroundColor Green
Write-Host ""
