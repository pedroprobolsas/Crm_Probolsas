/*
  # Modificación de la Función de Webhook para Usar la Extensión HTTP

  Este script modifica la función notify_message_webhook para usar la extensión http
  en lugar de pg_net, como una alternativa si pg_net no está funcionando correctamente.
*/
...
SELECT 
  ...
  'Mensaje de prueba para webhook de cliente (usando extensión HTTP)',
  'client',
  client_id,
  'text',
  'sent'
...
BEGIN
  ...
  4. Se insertó un mensaje de prueba
