# Script para aplicar todas las soluciones en un solo paso, incluyendo la actualización de las Edge Functions, la verificación del webhook de IA y la actualización de la documentación
# Este script ejecuta todos los scripts PowerShell para solucionar el problema del webhook de IA

# Mostrar información
Write-Host "Aplicando todas las soluciones para el problema del webhook de IA, incluyendo la actualización de las Edge Functions, la verificación del webhook de IA y la actualización de la documentación..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Todas las soluciones han sido aplicadas correctamente, incluyendo la actualización de las Edge Functions, la verificación del webhook de IA y la actualización de la documentación." -ForegroundColor Green
Write-Host ""
