# Script para aplicar todas las soluciones en un solo paso, incluyendo la actualización de las Edge Functions
# Este script ejecuta todos los scripts PowerShell para solucionar el problema del webhook de IA

# Mostrar información
Write-Host "Aplicando todas las soluciones para el problema del webhook de IA, incluyendo la actualización de las Edge Functions..." -ForegroundColor Cyan
Write-Host ""
